...
import { ApiRs, Params } from "../../shared/interface/core.interface";
...
export class RoleComponent {
  ...
  @Select(RoleState.role) role$: Observable<ApiRs<Role[]>>;
  ...
  ngOnInit() {
    this.role$.subscribe(role => {
      ...
      this.tableConfig.total = role ? role?.data?.length : 0;
    });
  }
